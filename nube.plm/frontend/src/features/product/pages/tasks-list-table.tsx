/**
 * TasksListTable - Task table with product context
 *
 * Shows tasks with parent product name column
 */
...
export interface TasksListTableDisplaySettings {
  showStatus: boolean;
...
export function TasksListTable({
  ...
  const handleDelete = (task: Task) => {
    console.log('[TasksListTable] Delete clicked - Task:', task);
      ...
      >
        <thead>
          <tr style={{ borderBottom: '1px solid #ddd', textAlign: 'left' }}>
            ...
            <th style={{ padding: cellPadding, fontWeight: 600 }}>Product</th>
        ...
        <tbody>
          {tasks.map((task) => {
            ...
            const product = task.parentId ? productsMap.get(task.parentId) : null;
