...
export function TaskFormDialog({ defaultGate, editTask, client, saving, onSave, onClose }: {
  defaultGate?: GateId;
  editTask?: any;
  client: any;
  saving: boolean;
      ...
      <DialogContent className="sm:max-w-[520px]">
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <Field label="Progress (%)"><Input type="number" min="0" max="100" value={progress} onChange={(e: any) => setProgress(e.target.value)} /></Field>
          </div>
